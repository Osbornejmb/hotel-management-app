...
import { X, Home, Users, Calendar, CreditCard, List, ClipboardList, Bed, User, LogOut } from 'lucide-react';

const SidebarAdmin = ({ activeSection, setActiveSection, isMobile, isOpen, setOpen }) => {
  const navIcons = {
    dashboard: Home,
    employee: Users,
    attendance: Calendar,
