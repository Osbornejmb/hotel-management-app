            ...
            <div style={{ 
              ...
              {employeeDetails ? (
                employeeDetails.error ? (
                  <div style={{ color: '#dc2626' }}>{employeeDetails.error}</div>
                ) : (
                  <div style={{ fontSize: '14px', color: '#374151', marginBottom: 12 }}>
                    <div><strong>Email:</strong> {employeeDetails.profile.email}</div>
                    <div><strong>Contact:</strong> {employeeDetails.profile.contactNumber}</div>
                    <div><strong>Job Title:</strong> {employeeDetails.profile.jobTitle}</div>
              ...
              {employeeDetails ? (
                employeeDetails.error ? null : (
                  <ul style={{ fontSize: '14px', color: '#374151', paddingLeft: 16 }}>
                    {employeeDetails.tasks && employeeDetails.tasks.length > 0 ? (
                      employeeDetails.tasks.map(task => (
                        <li key={task._id}>
                          <strong>{task.title || 'Untitled Task'}</strong>
                          {task.status ? ` (${task.status})` : ''}
                          {/* Add more task info as needed */}
                        </li>
                      ))
                    ) : (
