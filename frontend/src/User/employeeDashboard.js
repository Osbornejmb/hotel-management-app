...
const EmployeeDashboard = () => {
  ...
  const tasks = [
    { 
      id: 1,
      title: "Room Deep Cleaning - Room 505", 
      assignedDate: "December 5,", 
      assignedTime: "1:45 PM", 
      assignee: "Vivian Tabassamy", 
      status: "In Progress", 
      type: "Room Service",
      description: "Deep cleaning of room 505 including bathroom, floors, and surfaces.",
      priority: "High"
    },
    { 
      id: 2,
      title: "Aircon Cleaning - Room 505", 
      assignedDate: "December 5,", 
      assignedTime: "1:45 PM", 
      assignee: "Vivian Tabassamy", 
      status: "In Progress", 
      type: "Maintenance",
      description: "Thorough cleaning and maintenance of air conditioning unit in room 505.",
      priority: "Medium"
    }
  ];
